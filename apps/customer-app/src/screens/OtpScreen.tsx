...
const styles = StyleSheet.create({
  ...
  otpDotFilled: { backgroundColor: '#e23744' },
  ...
  button: { backgroundColor: '#e23744', paddingVertical: 18, borderRadius: 12, alignItems: 'center', shadowColor: '#e23744', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 5, marginBottom: 24 },
