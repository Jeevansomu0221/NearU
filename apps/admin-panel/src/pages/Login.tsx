  ...
  const loginWithPassword = async () => {
    try {
      ...
      if (error.code === "ERR_NETWORK" || error.message === "Network Error") {
        setError(
          `Backend is not reachable at ${API_BASE_URL}. Check your internet connection, confirm api.vyaha.com is up, or set VITE_API_URL if you use a different backend.`
        );
      } else {
